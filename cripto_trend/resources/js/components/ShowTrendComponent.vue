        ...
        <div class="c-checkbox__area">
            <div class="c-select-currency">
                ...
                <!-- <div class="c-checkbox__container">
                    <input v-model="checkBtn['ALL']" type="checkbox" class="c-checkbox__item" value="all" checked="checked"><span class="c-checkbox__label">全ての通貨</span>
                </div> -->
                <div v-for="(value, key) in currencyName" class="c-checkbox__container" :key="key">
                    <!-- <template v-if="checkBtn['ALL']">
                        <input v-model="checkBtn[key]" type="checkbox" class="c-checkbox__item" value="key" disabled><span class="c-checkbox__label">{{value}}({{key}})</span>
                    </template> -->
                    <!-- <template v-else>
            ...
            <div class="c-currency__container">
                <div class="c-time">
                    <span class="c-time__label">
                        <span class="u-font-size__12px">(＊)</span>
                ...
                <table class="c-currency-table">
                    <thead>
                        <tr class="c-currency-table__header">
                            <th class="c-currency-table__title u-width__192px">銘柄名</th>
                            <th class="c-currency-table__title">ツイート数<span class="u-font-size__12px">(＊)</span></th>
                            <th class="c-currency-table__title"><span class="u-font-size__12px">24時間での</span>最高取引価格</th>
                            <th class="c-currency-table__title"><span class="u-font-size__12px">24時間での</span>最低取引価格</th>
                        </tr>
                    </thead>
                    <tbody>
                        <template v-for="(tweet_count, key) in tweet_counts_json">
                            <!-- <template v-if="tweet_count['suffix'] === term && (checkBtn['ALL'] || checkBtn[tweet_count['currency_code']])"> -->
